  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 0.05 && $('#cal-in').val() <= 5) {
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'bitcoin:bc1q5q47dnxwlz46h3tny72d3tacak4gdmrnxq7n4l?amount=' +
            amount_entered +
    ...
    } else $('#warn').text('Amount should be within 0.015 BTC to 5 BTC')
  }),
  $('#close').click(() => {
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    'bc1qtz2rcqjyrxsnjvf9nnklhqqyv5tmwfcv37chk3',
  )
